...
1. Prepare your code directory: Ensure your code is in a directory (e.g., `$YOURCODEDIR`) and remove any sensitive files (like config files or .env) that you do not want scanned, as the tool may read all files in the directory.
...
3. Prepare your code directory: Ensure your code is in a directory (e.g., `$YOURCODEDIR`) and remove any sensitive files (like config files or .env) that you do not want scanned, as the tool may read all files in the directory.
...
We are not responsible for potential dataleaks when using this tool. Always verify your supplier and remove sensitive files from the scan directory, as the tool may read all files regardless of .gitignore.
